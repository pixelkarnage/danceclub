 ...
 */
class ActionLinkViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper {
	 ...
	 * @param string $class CSS class tag
	 * @return string The <a> tag
	 * @see \TYPO3\CMS\Backend\Utility::editOnClick()
	 */
	public function render($parameters, $class = '', $returnUrl = '') {
